...
```
Centroid plot shows distance from gene mean value to global mean value. Positive or negative shows direction to the global mean.  Yes, it can happen that all values for some gene in centroid plot are positivive. Number of genes selected when threshold = `r bestTh` : `r numberOfGenes`.
